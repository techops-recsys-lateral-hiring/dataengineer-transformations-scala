...
class WordCountTest extends AnyFeatureSpec with DefaultFeatureSpecWithSpark with GivenWhenThen {
  Feature("Word Count application") {
    ignore("Word Count application - Acceptance test for basic use") {
